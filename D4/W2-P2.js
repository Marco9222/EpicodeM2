/* ESERCIZIO 1 OK
  Fornito il seguente oggetto, scrivi del codice per rimuovere l'ultimo elemento
...
/* ESERCIZIO 4 DUBBI
  Scrivi del codice per ricavare solamente i valori PARI da un array 
  composto da soli valori numerici.
 */

/*let numeri = [1, 2, 3, 4, 5];

let even = numeri.filter(number
  { return number => % 2 === 0;
  });
...
let sum = numeri.reduce(function (a, b) {
  return a + b;
}, 0);
console.log(sum);*/
...
/* ESERCIZIO 9 OK
  Sostituisci ogni stringa contenuta in un array con un numero 
  rappresentante la sua lunghezza.
  es.: ["EPICODE", "is", "great"] => [7, 2, 5]
*/

/*let array = ["ciao", "sono", "io"];
...
/*const conteggio = movies.length;
console.log(conteggio);*/


/* ESERCIZIO 14 FINIRE
  Scrivi del codice per creare un array con solamente i titoli dei film 
  contenuti nell'array fornito.
*/

/*let titolo = movies[0].Title;
console.log(titolo);
...
/* ESERCIZIO 15
  Scrivi del codice per ottenere dall'array fornito solamente i film usciti 
  nel millennio corrente.
*/

/*const greaterThan2000 = movies.year.filter(element => element >= 2000);
...
/* ESERCIZIO 17
  Scrivi del codice per calcolare la somma di tutti gli anni 
...
/* ESERCIZIO 18
  Scrivi del codice per recuperare tutti i film dall'array 
